...
OUTPUT_DIR=$SCRATCH_DIR/models/baseline/xlnet-large/$TASK/$SEED
mkdir -p $OUTPUT_DIR

LOG_FILE_DIR=logs/baseline/xlnet-large/$TASK
...
then
    METRICS+=("acc")
    MM_OUTPUT_DIR=$SCRATCH_DIR/models/baseline/xlnet-large/$TASK-MM/$SEED
    MM_LOG_FILE_DIR=logs/baseline/xlnet-large/$TASK-MM
